...
void parseSingleParameter(XmlRpc::XmlRpcValue& params, std::vector<double>& param, std::string param_name);

void parseSingleParameter(XmlRpc::XmlRpcValue& params, std::vector<std::string>& param, std::string param_name);
